...
class OpenRouterProvider(
    ...
    override val id: String = AIProviderType.OPENROUTER.id
    override val type: AIProviderType = AIProviderType.OPENROUTER
    override var config: ProviderConfig = ProviderConfig(type = type, priorityOrder = 4)
    ...
    override suspend fun generateResponse(
        ...
        try {
            ...
            val url = config.customEndpointUrl ?: "https://openrouter.ai/api/v1/chat/completions"

            val messagesArray = JSONArray()
            messagesArray.put(
                JSONObject().put("role", "system")
                    .put("content", "You are VoidCore, an intelligent on-device assistant. Answer directly.")
            )
            ...
            val request = Request.Builder()
                ...
                .addHeader("HTTP-Referer", "https://voidcore.aistudio.app")
                .addHeader("X-Title", "VoidCore AI")
            ...
            GenerationResponse(
                ...
                latencyMs = latency,
                isSuccess = false,
                errorMessage = "No response choice returned from OpenRouter"
            )
        } catch (e: Exception) {
            val latency = System.currentTimeMillis() - startTime
            GenerationResponse(
